...
public final class a {
   ...
   public static final int[][] a(int var0, DataInputStream var1) throws IOException {
      ...
      try {
         int[][] var4 = a(var1 = new DataInputStream(HG.a.getClass().getResourceAsStream("m" + var0)), true);
         b(var1);
         var1.close();
         System.gc();
         return var4;
         ...
         label83: {
            try {
               ...
               for(int var5 = 0; var5 < var0; ++var5) {
                  var1 = new DataInputStream(HG.a.getClass().getResourceAsStream("m" + (52 + var5)));
                  a[var5] = a(var1, false);
                  b(var1);
                  b[var5] = c.x;
                  var1.close();
                           ...
                           if (var19 < var12 || HG.d(var9) == 0) {
                              ...
                              if ((var28 = c.a(var8)) != -1) {
                                 ...
                                 if (!var18 && var22 == 0 && var16 != -1) {
                                    int var29;
                                    int var30 = (HG.d(var29 = var5 / 20) >> 2) + HG.d(2) + (HG.d(var29) >> 2) + HG.d(2) + (HG.d(var29) >> 2) + HG.d(2);
                                    int var31 = (var29 >> 2) + 2;
                                    var8[var28][var16] = var31 + var30;
                                 } else if (var16 != -1) {
                                    var8[var28][var16] = HG.d(8) + 1;
                                 }
                              }
                           }
                        }
   ...
   public static final void g() {
      ...
      if ((short)((c.D[var0 + HG.C] & -65536) >> 16) <= 0) {
         if (a() >= 0) {
            g();
         } else {
            HG.C = 0;
         ...
         if (var1[17 + var3] >= 0) {
            ...
            if (var2[21 + var3] >= 0) {
               ...
               if ((var5 = (var2[13] & 512) != 0) && var9) {
                  if ((var6 = HG.d(100)) >= 70) {
                     a(var0, 17 + var3, HG.d(c.h.length - 1));
                  } else if (var6 >= 40) {
   ...
   public static final void a(int var0, int var1, int var2) {
      ...
      var10000 = c.q[var0];
      var10000[var1] |= (short)var3 << 16 & -65536;
      if (HG.d(100) <= c.a[c.q[var0][11]][25]) {
         c(c.y[var3]);
      }
